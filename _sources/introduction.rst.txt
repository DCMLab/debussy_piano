...
-  ``debussy_suite_bergamasque/MS3/l075-01_suite_prelude.mscx``: Uncompressed MuseScore file including the music and annotation labels.
-  ``debussy_suite_bergamasque/notes/l075-01_suite_prelude.tsv``: A table of all note heads contained in the score and their relevant features (not each of them represents an onset, some are tied together)
-  ``debussy_suite_bergamasque/measures/l075-01_suite_prelude.tsv``: A table with relevant information about the measures in the score.
-  ``debussy_suite_bergamasque/harmonies/l075-01_suite_prelude.tsv``: A list of the included harmony labels (including cadences and phrases) with their positions in the score.
