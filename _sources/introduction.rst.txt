...
-  ``debussy_suite_bergamasque/MS3/l075-01_suite_prelude.mscx``: Uncompressed MuseScore 3.6.2 file including the music and annotation labels.
-  ``debussy_suite_bergamasque/notes/l075-01_suite_prelude.notes.tsv``: A table of all note heads contained in the score and their relevant features (not each of them represents an onset, some are tied together)
-  ``debussy_suite_bergamasque/measures/l075-01_suite_prelude.measures.tsv``: A table with relevant information about the measures in the score.
-  ``debussy_suite_bergamasque/chords/l075-01_suite_prelude.chords.tsv``: A table containing layer-wise unique onset positions with the musical markup (such as dynamics, articulation, lyrics, figured bass, etc.).
-  ``debussy_suite_bergamasque/harmonies/l075-01_suite_prelude.harmonies.tsv``: A table of the included harmony labels (including cadences and phrases) with their positions in the score.
...
.. code:: python
   ...
   labels = ms3.load_tsv('debussy_suite_bergamasque/harmonies/l075-01_suite_prelude.tsv')
   notes = ms3.load_tsv('debussy_suite_bergamasque/notes/l075-01_suite_prelude.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/debussy_piano/issues>`__ and feel free to fork and submit pull requests.
